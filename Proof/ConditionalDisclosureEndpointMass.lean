...
namespace Kriterion.ConditionalDisclosure.Endpoint
...
/-- This is the actual online simulator source, including its checked fresh hash
program and selected curve programming after the first transcript. -/
...
end Kriterion.ConditionalDisclosure.Endpoint
